            ...
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-muted-foreground flex items-center gap-2">
                ...
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p className="max-w-xs">Most recent solar flare intensity classification (X, M, or C class)</p>
                  </TooltipContent>
                </Tooltip>
              </CardTitle>
            </CardHeader>
            ...
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-muted-foreground flex items-center gap-2">
                ...
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p className="max-w-xs">Highest recorded stock price volatility percentage during the analysis period</p>
                  </TooltipContent>
                </Tooltip>
              </CardTitle>
            </CardHeader>
            ...
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-muted-foreground flex items-center gap-2">
                ...
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p className="max-w-xs">Statistical correlation coefficient between solar flares and market volatility</p>
                  </TooltipContent>
                </Tooltip>
              </CardTitle>
            </CardHeader>
            ...
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-muted-foreground flex items-center gap-2">
                ...
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p className="max-w-xs">Total trading volume on the day with highest market activity</p>
                  </TooltipContent>
                </Tooltip>
              </CardTitle>
            </CardHeader>
